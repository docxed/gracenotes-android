            ...
            <HStack space={9}>
                ...
                <VStack alignItems="center" space={6}>
                    ...
                    <IconButton
                        ...
                        onPress={() => { props.navigation.navigate("Admin_edit_h") }}
                    />
                    <IconButton
                        borderRadius="full"
                        variant="outline"
...
function Admin_help_Screen({ navigation }) {
    return (
        <NativeBaseProvider>
            <Center flex={1} px="3">
                ...
                <Heading fontSize={30} color="warning.500">จัดการโพสต์ความช่วยเหลือ</Heading>
                <Divider my="3" />
                <ScrollView><Admin_list_Help navigation={navigation}/></ScrollView>
            </Center>
        </NativeBaseProvider>
    );
}
